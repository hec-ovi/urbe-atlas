...
Package 0.12.0 returns blueprint 0.26.0 and architecture 1.0.0. Default district streets use uniform 4.2 m paving, 0.2 m curbs, 0.5 m gutters and a 2 m-deep parking bay on one kerb of every street. Whole-block finishes and road district styles are explicit. Selected central avenues reserve 3.4 m ornamental islands separately from traffic lanes.
