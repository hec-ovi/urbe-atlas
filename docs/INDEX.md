...
- src/ui: saved-city workspace, server generation, 2D/3D inspection and explicit exterior builds. src/ui/CONTRACT.md. Depends on the city catalog, root blueprint and Engine exterior/manifest contracts.
