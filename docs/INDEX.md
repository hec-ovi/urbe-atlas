...
- src/ui: city creation and saved-blueprint inspection with 2D/3D views, filters, file exchange and same-origin URL loading. src/ui/CONTRACT.md. Depends on the root contract and the optional Engine assembly manifest contract.
