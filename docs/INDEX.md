...
- src/geom: polygon operations, exact vertex-contact noding, diagnostic precision contours, full segment coverage and shared grid-cell contacts. src/geom/CONTRACT.md. Depends on root Atlas coordinates and the existing integer clipping library.
