...
- src/geom: fixed-point polygon operations and shared grid-cell crossing normalization. src/geom/CONTRACT.md. Depends on root Atlas coordinates and the existing integer clipping library.
