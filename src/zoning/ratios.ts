...
export const RESIDENTS_PER_FACILITY: Partial<Record<BuildingParcelType, number>> = {
  hospital: 75_000,
  clinic: 15_000,
  police: 50_000,
  military: 400_000,
...
export const ANCHOR_FACILITIES: BuildingParcelType[] = ['hospital', 'police', 'military', 'mall'];

/** Minimum lot area demanded by each facility type, m2. */
export const MIN_FACILITY_AREA: Partial<Record<BuildingParcelType, number>> = {
  hospital: 4_000,
  clinic: 400,
  police: 1_200,
  military: 6_000,
