...
- Exact opposite numeric incidences and matching domain edges resolve first. Only unresolved edges and their incident vertices participate in conversion inference; a nearby fully paired interior seam is not a conversion constraint. Every exact containing edge remains a constraint when that vertex needs a conversion witness.
