...
The reserved rectangle remains inside the requested size. The caller owns land and perimeter frontages outside that rectangle. Parking occurs on at most one wide frontage per selected block, with a 15% selection probability and complete clearances. Output includes explicit slot footprints. Same seed, settings and side selection produce identical data.
