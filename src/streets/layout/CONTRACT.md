...
Native parking occurs on at most one eligible frontage per selected block, with a 15% selection probability: district 4 m paved native bays (6 x 2 m slots, 2.2 m walking), source 6 m paved native bays (6 x 2.5 m slots, 3.5 m walking). Reserved highway frontages are ineligible. Bays have 2 or 3 slots and 2 m support aprons; complete support stays 6 m clear of corners. Guardrails occupy 2, 4 or 6 m groups on sparse seeded frontages, at most two groups per block. Parking and rail choices use independent seed streams. Same seed, settings and side selection produce identical data.
